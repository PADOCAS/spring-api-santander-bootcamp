...
public record UsuarioDTO(
    ...
    public UsuarioDTO(Usuario model) {
        this(
                ...
                Optional.ofNullable(model.getListFuncionalidade()).orElse(Collections.emptyList()).stream()
    ...
    public Usuario toModel() {
        ...
        model.setListNoticia(
                Optional.ofNullable(this.listNoticia).orElse(Collections.emptyList()).stream().map(NoticiaDTO::toModel)
                        .collect(Collectors.toList()));
